<template>
  ...
  <div class="container mx-auto mt-[-180px]">
    ...
    <div class="form-area bg-white rounded-xl p-8 drop-shadow-md mb-10 md:flex">
      <div class="md:w-1/3 xs:w-full bg-[#318f57] rounded-xl p-8 text-white">
        <p class="text-[24px] text-blod">নিয়মাবলী -</p>
        <ol class="list-decimal">
          <li>
            পিতা, মাতা, ভাই, বোন, ছেলে কিংবা মেয়ে ব্যতিত অন্য কোন ব্যাক্তি
            রেজিষ্ট্রেশনের আওতাভুক্ত হবে না।
          </li>

          <li>
            রেজিষ্ট্রেশনের পূর্বে উল্লেখিত মাধ্যমগুলোতে টিকেটের মূল্য পরিশোধ
            করুন।
          </li>

          <li>
            সাবেক শিক্ষার্থীদের জন্য প্রতি টিকেটের মূল্য ১০০০ টাকা এবং বর্তমান
            শিক্ষার্থীদের জন্য ৫০০ টাকা নির্ধারন করা হয়েছে।
          </li>

          <li>প্রতি ফ্যামিলি টিকেটের মূল্য ৫০০ টাকা নির্ধারন করা হয়েছে।</li>
        </ol>
      ...
      <div class="p-4 md:w-2/3 xs:w-full">
        <form @submit.prevent="signUp">
          ...
          <div class="md:flex mb-4">
            <div class="md:shrink-0 w-1/4">
              <label class="">
                পিতার নাম <span class="text-red">*</span>
              </label>
            </div>
            <div class="w-3/4">
          ...
          <div class="mb-5 bg-yellow-100 rounded-lg p-6 text-[24px] text-red-1000">
            ...
            <h6>
              ...
              শিক্ষার্থী <span class="font-semibold">৫,০০৳, </span> এবং ফ্যামিলি
              <span class="font-semibold">৫,০০৳, </span>
            </h6>
            <h6>
              <span class="font-semibold">নির্দেশনা: </span> মাদ্রাসার
              সাবেক-বর্তমান শিক্ষার্থী এবং তাদের পিতা, মাতা, ভাই, বোন, ছেলে,
              কিংবা মেয়ে ব্যাতীত অন্যকোন ব্যাক্তি রেজিষ্ট্রেশনের অন্তরভুক্ত হবে
              না।
            </h6>
          </div>
...
import unionsData from "../assets/data/unions.json";
...
async function sendSMS(mobile) {
  ...
  let url =
    "https://880sms.com/smsapi?api_key=" +
    APIKEY +
    "&type=text&contacts=" +
    mobile +
    "&senderid=" +
...
async function uploadImage(data): Promise<string> {
  ...
  if (field == "profile_image") {
    const { success, error } = await client.storage
      .from("jram")
      .upload(data.file_name, data.file, { upsert: true });
    if (error) {
